...
Usage:
    ...
    project-root: The root of the project (where _chico/ lives)
...
def main():
    ...
    # Paths
    chico_dir = project_root / "_chico"
    memory_dir = chico_dir / "memory"
    ...
    for config_file in ["config.yaml", "config.user.yaml"]:
        config.update(parse_yaml_config(chico_dir / config_file))
