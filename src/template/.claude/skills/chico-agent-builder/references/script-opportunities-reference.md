...
This document identifies deterministic operations that should be offloaded from the LLM into scripts for quality validation of Chico agents.
...
**What:** Detect if agent uses CHICO Advanced Context Pattern
