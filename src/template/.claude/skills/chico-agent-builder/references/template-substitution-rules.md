...
- `{module-code-or-empty}` → Module code prefix with hyphen (e.g., `cis-`) or empty for standalone. The `chico-` prefix is reserved for official Chico creations; user agents should not include it.
