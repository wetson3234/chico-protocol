...
| `sanctum-location` | Path to sanctum folder                                   | `{project-root}/_chico/memory/{skillName}/`                         |
...
Always use `{project-root}` prefix: `{project-root}/_chico/memory/{skillName}/`
...
- Correct: `{chico_builder_output_folder}/agent.md`
- Wrong: `{project-root}/{chico_builder_output_folder}/agent.md` (double-prefix)
