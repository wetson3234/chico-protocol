...
Run: `python3 scripts/resolve-customization.py chico-testarch-atdd --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-testarch-atdd --key inject.after`
