...
Run: `python3 scripts/resolve-customization.py chico-testarch-trace --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-testarch-trace --key inject.after`
