...
if (criticalGaps.length > 0) {
  recommendations.push({
    priority: 'URGENT',
    action: `Run /chico:tea:atdd for ${criticalGaps.length} P0 requirements`,
...
if (highGaps.length > 0) {
  recommendations.push({
    priority: 'HIGH',
    action: `Run /chico:tea:automate to expand coverage for ${highGaps.length} P1 requirements`,
...
recommendations.push({
  priority: 'LOW',
  action: 'Run /chico:tea:test-review to assess test quality',
  requirements: [],
});
