...
# dependencies = ["pyyaml"]
# ///
"""Merge module configuration into shared _chico/config.yaml and config.user.yaml.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Merge module config into shared _chico/config.yaml with anti-zombie pattern."
    )
    parser.add_argument(
        "--config-path",
        required=True,
        help="Path to the target _chico/config.yaml file",
    )
    parser.add_argument(
        "--module-yaml",
        required=True,
    ...
    parser.add_argument(
        "--user-config-path",
        required=True,
        help="Path to the target _chico/config.user.yaml file",
    )
    parser.add_argument(
        "--legacy-dir",
        help="Path to _chico/ directory to check for legacy per-module config files. "
