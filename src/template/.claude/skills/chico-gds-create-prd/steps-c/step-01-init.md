...
> **Note:** This PRD workflow is optional for Game Dev Studio projects. The GDD is the primary design document. PRDs are useful when integrating with external tools like chico-assist that expect PRD format.
