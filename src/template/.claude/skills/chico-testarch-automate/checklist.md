...
**Note:**  artifacts (story, tech-spec, PRD) are OPTIONAL - workflow can run without them
...
- [ ] **Note**: Absence of artifacts does NOT halt workflow
...
**Chico-Integrated Mode (if story available):**
...
- [ ] Document includes execution mode (Chico-Integrated, Standalone, Auto-discover)
...
### With Workflows (If Available - OPTIONAL)
...
- [ ] **Execution mode determined** (Chico-Integrated, Standalone, or Auto-discover)
...
- **automate does NOT require artifacts** - they are OPTIONAL enhancements
- If files not found, switch to Standalone Mode automatically
- Analyze source code directly without context
...
- Message: "Framework scaffolding required. Run `chico tea *framework` first."
...
- **automate is flexible:** Can work with or without artifacts (story, tech-spec, PRD are OPTIONAL)
