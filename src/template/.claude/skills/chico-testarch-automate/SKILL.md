...
Run: `python3 scripts/resolve-customization.py chico-testarch-automate --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-testarch-automate --key inject.after`
