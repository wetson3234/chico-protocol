...
Run: `python3 scripts/resolve-customization.py chico-testarch-framework --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-testarch-framework --key inject.after`
