...
Run: `python3 scripts/resolve-customization.py chico-testarch-nfr --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-testarch-nfr --key inject.after`
