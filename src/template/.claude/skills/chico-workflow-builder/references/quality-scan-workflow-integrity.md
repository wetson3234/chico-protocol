...
| ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `name` MUST match the folder name, kebab-case. Module: `{code}-{skillname}`. Standalone: `{skillname}` | Naming convention identifies module affiliation. `chico-` prefix reserved for official Chico skills  |
...
- Domain-specific patterns the LLM wouldn't know (Chico config conventions, module metadata)
