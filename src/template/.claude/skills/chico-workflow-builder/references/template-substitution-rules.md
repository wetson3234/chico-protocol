...
- `{module-code-or-empty}` → Module code prefix with hyphen (e.g., `cmb-`) or empty for standalone. The `chico-` prefix is reserved for official Chico creations; user skills should not include it.
