---
name: chico-testarch-test-review
...
Run: `python3 scripts/resolve-customization.py chico-testarch-test-review --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-testarch-test-review --key inject.after`
