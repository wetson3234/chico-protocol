...
Analyze legacy PRD against core standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring core standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against core standard
...
- Manually check PRD for each section
...
**[R] Restructure to ** - Full conversion to standard format, then apply your edits
...
- All 6 core sections analyzed for gaps
