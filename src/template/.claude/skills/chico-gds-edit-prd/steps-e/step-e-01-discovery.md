...
partyModeWorkflow: 'skill:chico-party-mode'
---
...
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow structure
...
**[C] Convert to Format** - Convert PRD to core standard structure, then apply your edits
