...
Run: `python3 scripts/resolve-customization.py chico-testarch-ci --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-testarch-ci --key inject.after`
