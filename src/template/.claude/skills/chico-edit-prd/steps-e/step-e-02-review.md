...
2. Analyze against core standards (from prd-purpose.md)
...
- IF A: Invoke the `chico-advanced-elicitation` skill, then return to discussion
- IF P: Invoke the `chico-party-mode` skill, then return to discussion
