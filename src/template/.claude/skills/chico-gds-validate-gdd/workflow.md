...
**Goal:** Validate existing Game Design Documents against GDS standards through comprehensive review.
...
"**Validate Mode: Validating an existing GDD against GDS standards.**"
