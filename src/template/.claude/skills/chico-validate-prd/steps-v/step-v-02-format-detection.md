...
Detect if PRD follows standard format and route appropriately - classify as Standard / Variant / Non-Standard, with optional parity check for non-standard formats.
...
### 2. Check for PRD Core Sections

Check if the PRD contains the following PRD core sections:
...
This PRD does not follow core standard structure (only {count}/6 core sections present).
...
**[A] Parity Check** - Analyze gaps and estimate effort to reach PRD parity
