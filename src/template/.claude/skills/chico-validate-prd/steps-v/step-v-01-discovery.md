...
- IF A: Invoke the `chico-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `chico-party-mode` skill, and when finished redisplay the menu
