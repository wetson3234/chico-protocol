...
Run: `python3 scripts/resolve-customization.py chico-teach-me-testing --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-teach-me-testing --key inject.after`
