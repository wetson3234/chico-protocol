...
cd /path/to/chico-protocol-test-architecture-enterprise

# Run the workflow
chico run teach-me-testing
```
...
- **Knowledge Fragments:** <https://github.com/chico-code-org/chico-protocol-test-architecture-enterprise/tree/main/src/agents/chico-tea/resources/knowledge>
