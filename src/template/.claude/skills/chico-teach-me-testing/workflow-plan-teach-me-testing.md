...
**Target Path:** {project-root}/src/workflows/testarch/chico-teach-me-testing/
...
- **File I/O:** Included - Operations: Read TEA docs (/docs/_.md), read knowledge fragments (/src/agents/chico-tea/resources/knowledge/_.md), write progress file ({user}-tea-progress.yaml), write session notes, write completion certificate
...
- Local files: `/docs/*.md`, `/src/agents/chico-tea/resources/knowledge/*.md`
- Online docs: `<https://chico-code-org.github.io/chico-protocol-test-architecture-enterprise/`>
...
**Location:** {external-project-root}/\_chico-output/bmb-creations/workflows/teach-me-testing/
...
1. `steps-v/step-v-01-validate.md` ✓ - Comprehensive quality validation against core standards, generates validation report
...
**Source (Staging):**
`{external-project-root}/_chico-output/bmb-creations/workflows/teach-me-testing/`

**Target (Production):**
`{project-root}/src/workflows/testarch/chico-teach-me-testing/`

**Command:**

```bash
cp -r {external-project-root}/_chico-output/bmb-creations/workflows/teach-me-testing \
...
2. Test the workflow: `chico run teach-me-testing`
3. Validate: `chico run teach-me-testing -v`
