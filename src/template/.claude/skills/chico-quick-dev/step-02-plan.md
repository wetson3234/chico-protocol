...
Before approving, you can open the spec file in an editor or ask me questions and tell me what to change. You can also use `chico-advanced-elicitation`, `chico-party-mode`, or `chico-code-review` skills, ideally in another session to avoid context bloat.
