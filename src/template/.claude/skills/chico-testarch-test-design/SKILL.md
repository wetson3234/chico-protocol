---
name: chico-testarch-test-design
...
Run: `python3 scripts/resolve-customization.py chico-testarch-test-design --key inject --key additional_resources`
...
Run: `python3 scripts/resolve-customization.py chico-testarch-test-design --key inject.after`
