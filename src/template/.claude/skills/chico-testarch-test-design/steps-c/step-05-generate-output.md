...
## 4. Generate Handoff Document (System-Level Mode Only)
...
> **Note**: The handoff document is designed for consumption by 's `create-epics-and-stories` workflow. It is only generated for system-level test designs where epic/story decomposition is relevant.
