...
workflowPath: {project-root}/src/workflows/testarch/chico-testarch-test-design
...
Standard core config variables treated as valid exceptions: bmb_creations_output_folder, communication_language, document_output_language, output_folder, planning_artifacts, project-root, project_name, test_artifacts, user_name
