...
description: 'Document Parity Check - Analyze non-standard PRD and identify gaps to achieve PRD parity'
...
Analyze non-standard PRD and identify gaps to achieve PRD parity, presenting user with options for how to proceed.
...
- 🎯 Analyze each PRD section for gaps
...
### 1. Analyze Each PRD Section

For each of the 6 PRD core sections, analyze:
...
Your PRD is missing {count} of 6 core PRD sections. The overall effort to reach core standard is: **{effort level}**
...
- All 6 PRD sections analyzed for gaps
