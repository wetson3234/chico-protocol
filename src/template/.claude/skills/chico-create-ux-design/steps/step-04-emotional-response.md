...
- Invoke the `chico-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `chico-party-mode` skill with the current emotional response definition
