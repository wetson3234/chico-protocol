...
- Invoke the `chico-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `chico-party-mode` skill with the current inspiration analysis
