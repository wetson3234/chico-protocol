...
- Invoke the `chico-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `chico-party-mode` skill with the current visual foundation
