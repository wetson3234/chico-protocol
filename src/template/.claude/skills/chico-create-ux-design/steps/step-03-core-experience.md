...
- Invoke the `chico-advanced-elicitation` skill with the current core experience content
...
- Invoke the `chico-party-mode` skill with the current core experience definition
