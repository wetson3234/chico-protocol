...
- Invoke the `chico-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `chico-party-mode` skill with the current defining experience
