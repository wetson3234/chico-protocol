...
- Invoke the `chico-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `chico-party-mode` skill with the current component strategy
