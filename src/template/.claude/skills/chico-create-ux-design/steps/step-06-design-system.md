...
- Invoke the `chico-advanced-elicitation` skill with the current design system content
...
- Invoke the `chico-party-mode` skill with the current design system choice
