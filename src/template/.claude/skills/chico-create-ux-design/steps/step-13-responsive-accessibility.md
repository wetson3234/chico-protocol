...
- When 'A' selected: Invoke the `chico-advanced-elicitation` skill
- When 'P' selected: Invoke the `chico-party-mode` skill
...
- Invoke the `chico-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `chico-party-mode` skill with the current responsive/accessibility strategy
