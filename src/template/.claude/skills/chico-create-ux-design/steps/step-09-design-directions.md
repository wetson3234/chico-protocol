...
- Invoke the `chico-advanced-elicitation` skill with the current design direction content
...
- Invoke the `chico-party-mode` skill with the current design direction
