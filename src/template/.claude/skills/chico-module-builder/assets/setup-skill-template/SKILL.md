...
3. Check for per-module configuration at `{project-root}/_chico/{module-code}/config.yaml` and `{project-root}/_chico/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_chico/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_chico" --module-code {module-code}
```
...
```bash
python3 ./scripts/cleanup-legacy.py --chico-dir "{project-root}/_chico" --module-code {module-code} --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
