...
# dependencies = []
# ///
"""Merge module help entries into shared _chico/module-help.csv.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Merge module help entries into shared _chico/module-help.csv with anti-zombie pattern."
    )
    parser.add_argument(
        "--target",
        required=True,
        help="Path to the target _chico/module-help.csv file",
    )
    parser.add_argument(
        "--source",
        required=True,
    ...
    parser.add_argument(
        "--legacy-dir",
        help="Path to _chico/ directory to check for legacy per-module CSV files.",
    )
    parser.add_argument(
        "--module-code",
